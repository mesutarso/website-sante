...
const categories: CooperationCategory[] = [
  ...
  {
    title: "ARC\u00A0CSU",
    def: "Autorité de Régulation et de Contrôle de la Couverture Santé Universelle",
        ...
        <Container className={""}>
          ...
          >
            {categories.map((category, index) => (
              <Link href={category.link} key={index} target="_blank">
              <motion.div
                key={index}
